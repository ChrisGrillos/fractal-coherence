-- Test fixture: snapshot of plasma-ai/fractal fractal/core/schema.sql
-- Source: https://github.com/plasma-ai/fractal (Apache-2.0). Vendored
-- unmodified below this header so the integration demo can run without
-- the plasma-fractal package installed. Prefer the installed package's
-- schema when available (see demo_fractal_epoch.find_fractal_schema).
